...
@section('content')
    ...
    <form action="/store" method="post" class="container">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" value="{{ old('ICNo') }}" name="ICNo" class="form-control" id="ICNo" 
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <input type="tel" value="{{ old('contactNo') }}" name="contactNo" class="form-control" id="contactNo" 
                    pattern="\d{9,10}" title="Sila berikan nombor telefon yang betul" required>
            </div>

            <label for="officeNo" class="col-sm-2 col-form-label">Nombor Telefon Pejabat</label>
            <div class="col-sm-4">
                <input type="tel" value="{{ old('officeNo') }}" name="officeNo" class="form-control" id="officeNo">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                ...
                pattern=".{3,}" maxlength="25" 
                title="Tiga huruf ke atas">
            </div>
        </div>
