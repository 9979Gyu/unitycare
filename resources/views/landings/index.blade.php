        ...
        @if(Auth::check())
            ...
            <div class="flex">
                ...
                @if(Auth::user()->roleID == 1)
                    <button type="button" class="btn-primary big-button">
                ...
                @if(Auth::user()->roleID == 1 || Auth::user()->roleID == 2)
                    ...
                    <button type="button" class="btn-danger big-button">
                    ...
                    <button type="button" class="btn-success big-button">
                ...
                <button type="button" class="btn-warning text-light big-button">
                ...
                <button type="button" class="btn-dark big-button">
