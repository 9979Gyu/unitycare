...
@section('content')
    ...
    <!-- Print Modal -->
    <form method="post" action="/print-certificate" id="printForm">
        @csrf
        <div class="modal fade" id="printModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="printModalLabel">Muat Turun Sijil</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        Adakah anda pasti untuk muat turun sijil program?
                    </div>
                    <input type="text" id="participantID" name="participantID" value="" hidden>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-danger" id="print">Muat Turun</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                    </div>
                </div>
            </div>
